...
HD_PWD='C:/Users/Wegdan/Documents/GitHub/PLC_Project/plc_project2/PLC_Project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MAC_acc16.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MAC_acc16.tcl -notrace
