...
architecture Behavioral of MAC_Aprrox2x2 is
...
temp<="00000000"&bias;
mult1: multiplierapprox88 port map(x1,w1,M1);
mult2: multiplierapprox88 port map(x2,w2,M2);
