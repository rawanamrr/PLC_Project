...
end MAC_approx16_2x2;

architecture Behavioral of MAC_approx16_2x2 is

component approxMult_16x16_2x2 is
...
mult1: approxMult_16x16_2x2 port map(x1,w1,M1);
mult2: approxMult_16x16_2x2 port map(x2,w2,M2);
mult3: approxMult_16x16_2x2 port map(x3,w3,M3);
mult4: approxMult_16x16_2x2 port map(x4,w4,M4);
mult5: approxMult_16x16_2x2 port map(x5,w5,M5);
