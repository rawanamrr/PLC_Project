...
entity NeuralNetw_approx2x2 is
...
end NeuralNetw_approx2x2;

architecture Behavioral of NeuralNetw_approx2x2 is

component MAC_approx16_2x2 is
...
component HiddenNeuron_approx2x2 is
Port ( x1 : in STD_LOGIC_VECTOR (7 downto 0);
           x2 : in STD_LOGIC_VECTOR (7 downto 0);
...
begin
HN_1:HiddenNeuron_approx2x2 port map(x1,x2,w11,w21,bias,HN1_sig);
HN_2:HiddenNeuron_approx2x2 port map(x1,x2,w12,w22,bias,HN2_sig);
HN_3:HiddenNeuron_approx2x2 port map(x1,x2,w13,w23,bias,HN3_sig);
HN_4:HiddenNeuron_approx2x2 port map(x1,x2,w14,w24,bias,HN4_sig);
HN_5:HiddenNeuron_approx2x2 port map(x1,x2,w15,w25,bias,HN5_sig);
bias_out<="00000000"&bias;

MAC:MAC_approx16_2x2 port map(HN1_sig,HN2_sig,HN3_sig,HN4_sig,HN5_sig,wh1,wh2,wh3,wh4,wh5,bias_out,FINAL_MAC);
